            ...
            <div class="col-md-12">
                <div class="slider-desc-3 text-center">
                    <div class="wow rotateInDownLeft" data-wow-duration="2s" data-wow-delay="0.5s"
                         style="visibility: visible; animation-duration: 2s; animation-delay: 0.5s; animation-name: rotateInDownLeft;">
                    ...
                    <div class="slider-button wow fadeInUp" data-wow-duration="1s" data-wow-delay="2.5s"
                         style="visibility: visible; animation-duration: 1s; animation-delay: 2.5s; animation-name: fadeInUp;">
